    ...
    <div>
        <nav class="w3-sidebar w3-collapse w3-animate-left" id="mySidebar"><br>
            ...
            <div class="menu-block">
                <a href="index.html" onclick="w3_close()" class="menu-item unlinkify"><i
                        class="fa fa-house fa-fw fa-lg w3-margin-right"></i>Home</a>
                <a href="projects.html" onclick="w3_close()" class="menu-item unlinkify"><i
                        class="fa fa-th-large fa-fw fa-lg w3-margin-right"></i>Projects</a>
                <a href="store.html" onclick="w3_close()" class="menu-item unlinkify"><i
                        class="fa fa-store fa-fw fa-lg w3-margin-right"></i>Store</a>
                <a href="contact.html" onclick="w3_close()" class="menu-item unlinkify"><i
        ...
        <div class="overlay hide-on-large-screens" onclick="w3_close()" style="cursor:pointer" title="close side menu"
            id="myOverlay"></div>
    </div>
`);